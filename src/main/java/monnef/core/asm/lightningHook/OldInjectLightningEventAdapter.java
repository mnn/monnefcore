...
import static monnef.core.asm.lightningHook.OldInjectLightningEventAdapter.State.DONE;
import static monnef.core.asm.lightningHook.OldInjectLightningEventAdapter.State.LOOKING;
import static monnef.core.asm.lightningHook.OldInjectLightningEventAdapter.State.READ_CANSTRIKE;
...
public class OldInjectLightningEventAdapter extends MethodVisitor {
    ...
    public OldInjectLightningEventAdapter(MethodVisitor visitor) {
        super(ASM4, visitor);
        state = LOOKING;
    }
