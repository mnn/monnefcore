 ...
 * @see monnef.core.external.javassist.tools.reflect.Reflection#makeReflective(CtClass,CtClass,CtClass)
 * @see monnef.core.external.javassist.CannotCompileException
 */
