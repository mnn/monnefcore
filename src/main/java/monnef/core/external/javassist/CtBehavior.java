...
public abstract class CtBehavior extends CtMember {
     ...
     *
     * @see monnef.core.external.javassist.bytecode.MethodInfo#rebuildStackMap(ClassPool)
     */
     ...
     * It represents parameter types including type variables.
     * See {@link monnef.core.external.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     ...
     * See {@link monnef.core.external.javassist.bytecode.AttributeInfo}.
     *
     ...
     *
     * @see monnef.core.external.javassist.runtime.Cflow
     */
     ...
     * @see monnef.core.external.javassist.expr.Expr#replace(String)
     * @see #insertBefore(String)
     */
