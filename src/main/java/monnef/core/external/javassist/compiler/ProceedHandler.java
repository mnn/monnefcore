 ...
 *
 * @see monnef.core.external.javassist.compiler.JvstCodeGen#setProceedHandler(ProceedHandler, String)
 * @see monnef.core.external.javassist.compiler.JvstCodeGen#atMethodCall(Expr)
 */
