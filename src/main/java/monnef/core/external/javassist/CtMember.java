...
public abstract class CtMember {
     ...
     *
     * @see monnef.core.external.javassist.bytecode.SignatureAttribute#toFieldSignature(String)
     * @see monnef.core.external.javassist.bytecode.SignatureAttribute#toMethodSignature(String)
     ...
     * @see monnef.core.external.javassist.bytecode.SignatureAttribute.ObjectType#encode()
