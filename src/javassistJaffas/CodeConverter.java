...
import javassistJaffas.convert.*;
 ...
 *
 * @see javassistJaffas.CtClass#instrument(CodeConverter)
 * @see javassistJaffas.CtMethod#instrument(CodeConverter)
 * @see javassistJaffas.expr.ExprEditor
 */
public class CodeConverter {
     ...
     * @see javassistJaffas.CtMethod#setName(String)
     */
