 ...
 *
 * @see javassistJaffas.CtClass
 * @see javassistJaffas.ClassPath
 */
public class ClassPool {
     ...
     * @see javassistJaffas.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see javassistJaffas.bytecode.ConstPool#getClassInfo(int)
     * @see javassistJaffas.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see javassistJaffas.ByteArrayClassPath
     */
     ...
     * @see javassistJaffas.ClassPath
     * @see javassistJaffas.URLClassPath
     * @see javassistJaffas.ByteArrayClassPath
     */
