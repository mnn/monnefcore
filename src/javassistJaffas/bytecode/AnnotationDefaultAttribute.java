...
package javassistJaffas.bytecode;

import javassistJaffas.CtClass;
import javassistJaffas.bytecode.annotation.AnnotationsWriter;
import javassistJaffas.bytecode.annotation.MemberValue;
 ...
 * @see javassistJaffas.bytecode.annotation.MemberValue
 */
...
public class AnnotationDefaultAttribute extends AttributeInfo {
     ...
     *
     * @param cp            constant pool
     * @see #setDefaultValue(javassistJaffas.bytecode.annotation.MemberValue)
     */
     ...
     * @see javassistJaffas.bytecode.annotation.Annotation#createMemberValue(ConstPool, CtClass)
     */
