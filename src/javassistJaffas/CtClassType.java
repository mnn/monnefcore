...
import javassistJaffas.bytecode.AccessFlag;
import javassistJaffas.bytecode.AttributeInfo;
import javassistJaffas.bytecode.AnnotationsAttribute;
import javassistJaffas.bytecode.BadBytecode;
import javassistJaffas.bytecode.Bytecode;
import javassistJaffas.bytecode.ClassFile;
import javassistJaffas.bytecode.CodeAttribute;
import javassistJaffas.bytecode.ConstantAttribute;
import javassistJaffas.bytecode.CodeIterator;
import javassistJaffas.bytecode.ConstPool;
import javassistJaffas.bytecode.Descriptor;
import javassistJaffas.bytecode.EnclosingMethodAttribute;
import javassistJaffas.bytecode.FieldInfo;
import javassistJaffas.bytecode.InnerClassesAttribute;
import javassistJaffas.bytecode.MethodInfo;
import javassistJaffas.bytecode.ParameterAnnotationsAttribute;
import javassistJaffas.bytecode.SignatureAttribute;
import javassistJaffas.bytecode.annotation.Annotation;
import javassistJaffas.compiler.AccessorMaker;
import javassistJaffas.compiler.CompileError;
import javassistJaffas.compiler.Javac;
import javassistJaffas.expr.ExprEditor;
...
class CtClassType extends CtClass {
   ...
   /**
    ...
    /**
     * @see javassistJaffas.CtClass#prune()
     * @see javassistJaffas.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
