...
public abstract class CtClass {
     ...
     */
    public javassistJaffas.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see javassistJaffas.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see javassistJaffas.bytecode.SignatureAttribute.ClassSignature#encode()
     * @see javassistJaffas.bytecode.SignatureAttribute.MethodSignature#encode()
     ...
     * @see javassistJaffas.bytecode.Descriptor
     */
     ...
     *
     * @see javassistJaffas.CtConstructor
     */
     ...
     *
     * @see javassistJaffas.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see javassistJaffas.CtField.Initializer#byExpr(String)
     * @see javassistJaffas.CtField#CtField(CtField,CtClass)
     */
     ...
     * @see javassistJaffas.bytecode.AttributeInfo
     */
