 ...
 *
 * @see javassistJaffas.CtClass#instrument(ExprEditor)
 * @see javassistJaffas.CtMethod#instrument(ExprEditor)
 * @see javassistJaffas.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
