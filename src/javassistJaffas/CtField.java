...
import javassistJaffas.bytecode.*;
import javassistJaffas.compiler.Javac;
import javassistJaffas.compiler.SymbolTable;
import javassistJaffas.compiler.CompileError;
import javassistJaffas.compiler.ast.ASTree;
import javassistJaffas.compiler.ast.IntConst;
import javassistJaffas.compiler.ast.DoubleConst;
import javassistJaffas.compiler.ast.StringL;
...
public class CtField extends CtMember {
     ...
     * It represents a type including type variables.
     * See {@link javassistJaffas.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see javassistJaffas.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
     ...
     * See {@link javassistJaffas.bytecode.AttributeInfo}.
     *
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see javassistJaffas.CtField.Initializer#byNewArray(CtClass,int)
         * @see javassistJaffas.CtField.Initializer#byNewArray(CtClass,int[])
         */
