...
import monnef.core.external.javassistJaffas.bytecode.*;
import monnef.core.external.javassistJaffas.compiler.Javac;
import monnef.core.external.javassistJaffas.compiler.SymbolTable;
import monnef.core.external.javassistJaffas.compiler.CompileError;
import monnef.core.external.javassistJaffas.compiler.ast.ASTree;
import monnef.core.external.javassistJaffas.compiler.ast.IntConst;
import monnef.core.external.javassistJaffas.compiler.ast.DoubleConst;
import monnef.core.external.javassistJaffas.compiler.ast.StringL;
...
public class CtField extends CtMember {
     ...
     * It represents a type including type variables.
     * See {@link monnef.core.external.javassistJaffas.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see monnef.core.external.javassistJaffas.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
     ...
     * See {@link monnef.core.external.javassistJaffas.bytecode.AttributeInfo}.
     *
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see monnef.core.external.javassistJaffas.CtField.Initializer#byNewArray(CtClass,int)
         * @see monnef.core.external.javassistJaffas.CtField.Initializer#byNewArray(CtClass,int[])
         */
