...
package monnef.core.external.javassistJaffas.bytecode;

import monnef.core.external.javassistJaffas.CtClass;
import monnef.core.external.javassistJaffas.bytecode.annotation.AnnotationsWriter;
import monnef.core.external.javassistJaffas.bytecode.annotation.MemberValue;
 ...
 * @see monnef.core.external.javassistJaffas.bytecode.annotation.MemberValue
 */
...
public class AnnotationDefaultAttribute extends AttributeInfo {
     ...
     *
     * @param cp            constant pool
     * @see #setDefaultValue(monnef.core.external.javassistJaffas.bytecode.annotation.MemberValue)
     */
     ...
     * @see monnef.core.external.javassistJaffas.bytecode.annotation.Annotation#createMemberValue(ConstPool, CtClass)
     */
