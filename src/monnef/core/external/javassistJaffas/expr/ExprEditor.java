 ...
 *
 * @see monnef.core.external.javassistJaffas.CtClass#instrument(ExprEditor)
 * @see monnef.core.external.javassistJaffas.CtMethod#instrument(ExprEditor)
 * @see monnef.core.external.javassistJaffas.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
