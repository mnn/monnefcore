...
public abstract class CtClass {
     ...
     */
    public monnef.core.external.javassistJaffas.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see monnef.core.external.javassistJaffas.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see monnef.core.external.javassistJaffas.bytecode.SignatureAttribute.ClassSignature#encode()
     * @see monnef.core.external.javassistJaffas.bytecode.SignatureAttribute.MethodSignature#encode()
     ...
     * @see monnef.core.external.javassistJaffas.bytecode.Descriptor
     */
     ...
     *
     * @see monnef.core.external.javassistJaffas.CtConstructor
     */
     ...
     * are not included.
     *
     * @see monnef.core.external.javassistJaffas.CtMethod
     */
     ...
     *
     * @see monnef.core.external.javassistJaffas.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see monnef.core.external.javassistJaffas.CtField.Initializer#byExpr(String)
     * @see monnef.core.external.javassistJaffas.CtField#CtField(CtField,CtClass)
     */
     ...
     * @see monnef.core.external.javassistJaffas.bytecode.AttributeInfo
     */
