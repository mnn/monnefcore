...
public abstract class CtMember {
     ...
     *
     * @see monnef.core.external.javassistJaffas.bytecode.SignatureAttribute#toFieldSignature(String)
     * @see monnef.core.external.javassistJaffas.bytecode.SignatureAttribute#toMethodSignature(String)
