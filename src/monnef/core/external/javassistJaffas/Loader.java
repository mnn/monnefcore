 ...
 *
 * @see monnef.core.external.javassistJaffas.ClassPool
 * @see monnef.core.external.javassistJaffas.Translator
 */
public class Loader extends ClassLoader {
     ...
     * </ul>
     *
     * @see monnef.core.external.javassistJaffas.Loader#run(String[])
     */
    public static void main(String[] args) throws Throwable {
