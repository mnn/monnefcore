...
import monnef.core.external.javassistJaffas.convert.*;
 ...
 *
 * @see monnef.core.external.javassistJaffas.CtClass#instrument(CodeConverter)
 * @see monnef.core.external.javassistJaffas.CtMethod#instrument(CodeConverter)
 * @see monnef.core.external.javassistJaffas.expr.ExprEditor
 */
public class CodeConverter {
     ...
     * @see monnef.core.external.javassistJaffas.CtMethod#setName(String)
     */
