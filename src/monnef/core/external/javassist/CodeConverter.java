 ...
 *
 * @see monnef.core.external.javassist.CtClass#instrument(CodeConverter)
 * @see monnef.core.external.javassist.CtMethod#instrument(CodeConverter)
 * @see monnef.core.external.javassist.expr.ExprEditor
 */
public class CodeConverter {
     ...
     * @see monnef.core.external.javassist.CtMethod#setName(String)
     */
