...
import monnef.core.external.javassist.compiler.AccessorMaker;
...
class CtClassType extends CtClass {
   ...
   /**
    ...
    /**
     * @see monnef.core.external.javassist.CtClass#prune()
     * @see monnef.core.external.javassist.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
