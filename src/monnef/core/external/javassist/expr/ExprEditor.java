 ...
 *
 * @see monnef.core.external.javassist.CtClass#instrument(ExprEditor)
 * @see monnef.core.external.javassist.CtMethod#instrument(ExprEditor)
 * @see monnef.core.external.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
