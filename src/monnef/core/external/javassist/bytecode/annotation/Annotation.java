 ...
 *
 * @see monnef.core.external.javassist.bytecode.AnnotationsAttribute#getAnnotations()
 * @see monnef.core.external.javassist.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see MemberValue
...
public class Annotation {
     ...
     * the default value.
     *
     * @see monnef.core.external.javassist.bytecode.AnnotationDefaultAttribute
     */
