 ...
 *
 * @see monnef.core.external.javassist.CtClass
 * @see monnef.core.external.javassist.ClassPath
 */
public class ClassPool {
     ...
     * @see monnef.core.external.javassist.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see monnef.core.external.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see monnef.core.external.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see monnef.core.external.javassist.ByteArrayClassPath
     */
     ...
     * @see monnef.core.external.javassist.ClassPath
     * @see monnef.core.external.javassist.URLClassPath
     * @see monnef.core.external.javassist.ByteArrayClassPath
     */
